...
app.post("/vote", async (req, res) => {
    ...
    async function storeDataInBlockchain(vote) {
        console.log("Tambahkan kandidat ke voting contract");
    ...
    if (bool === true) {
        ...
        res.send("Kandidat pasangan calon telah ditambahkan ke Smart Contract");
    }
    else {
...
//     try {
//         const data = contractInstance.getVotingStatus()
